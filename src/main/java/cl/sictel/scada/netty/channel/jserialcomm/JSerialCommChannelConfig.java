 ...
 * </tr><tr>
 * <td>{@link JSerialCommChannelOption#DTR}</td><td>{@link #setDtr(boolean)}</td>
 * </tr><tr>
 * <td>{@link JSerialCommChannelOption#RTS}</td><td>{@link #setRts(boolean)}</td>
 * </tr><tr>
...
public interface JSerialCommChannelConfig extends ChannelConfig {
     ...
     */
    JSerialCommChannelConfig setDtr(boolean dtr);
     ...
     */
    JSerialCommChannelConfig setRts(boolean rts);
    ...
    @Override
    @Deprecated
    JSerialCommChannelConfig setMaxMessagesPerRead(int maxMessagesPerRead);
    ...
    @Override
    JSerialCommChannelConfig setAutoClose(boolean autoClose);
    ...
    @Override
    JSerialCommChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark);
